...
import { libraryCategories } from "@/config/library";
...
/**
 * Baris chip filter yang bisa discroll horizontal — "Semua", tiap
 * kategori dari `config/library.ts`, lalu chip "Favorit" terpisah di
 * ujung supaya filter kategori & favorit bisa dikombinasikan sekaligus.
 */
